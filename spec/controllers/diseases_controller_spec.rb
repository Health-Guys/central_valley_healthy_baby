...
RSpec.describe DiseasesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all diseases as @diseases" do
      ...
      expect(assigns(:diseases)).to eq([disease])
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created disease as @disease" do
        post :create, {:disease => valid_attributes}, valid_session
        expect(assigns(:disease)).to be_a(Disease)
        expect(assigns(:disease)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved disease as @disease" do
        post :create, {:disease => invalid_attributes}, valid_session
        expect(assigns(:disease)).to be_a_new(Disease)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested disease" do
        disease = Disease.create! valid_attributes
        put :update, {:id => disease.to_param, :disease => new_attributes}, valid_session
        disease.reload
    ...
    context "with invalid params" do
      it "assigns the disease as @disease" do
        disease = Disease.create! valid_attributes
        put :update, {:id => disease.to_param, :disease => invalid_attributes}, valid_session
        expect(assigns(:disease)).to eq(disease)
      end
